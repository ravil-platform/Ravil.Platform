...
namespace Ravil.Infrastructure.Data.Migrations
{
    ...
    [Migration("20210727112939_AddAttrOfAccount")]
    partial class AddAttrOfAccount
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.AccountAttr", b =>
                {
                    ...
                    b.Property<int>("AttrId1")
                        .HasColumnType("int");

                    b.Property<int?>("AttrValueId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.AccountAttr", b =>
                {
                    ...
                    b.HasOne("Ravil.Domain.Models.Data.Attr", null)
                        .WithMany("AttrAccounts")
                        .HasForeignKey("AttrId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ravil.Domain.Models.Data.AttrValue", null)
                        .WithMany("AccountAttrs")
                        .HasForeignKey("AttrValueId");
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.AttrValue", b =>
                {
                    b.HasOne("Ravil.Domain.Models.Data.AttrAccount", null)
                        .WithMany("AttrValues")
                        .HasForeignKey("AttrAccountId");
