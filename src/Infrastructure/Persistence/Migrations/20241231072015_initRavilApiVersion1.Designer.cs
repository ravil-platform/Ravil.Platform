...
namespace Persistence.Migrations
{
    ...
    [Migration("20241231072015_initRavilApiVersion1")]
    partial class initRavilApiVersion1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Address.Address", b =>
                {
                    ...
                    b.Property<DateTime>("UpdateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 12, 31, 10, 50, 14, 549, DateTimeKind.Local).AddTicks(7463));
            ...
            modelBuilder.Entity("Domain.Entities.User.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "6c15e7d6-ba1a-4624-aa4b-edda95dc3c59",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEDKVQjyRYH9bSKIKg7cMzaeQTUhU+ocRiKKvV5SSNSput7pYm2NyzfvlrVsDD1u2EA==",
                            PhoneNumberConfirmed = false,
                            RegisterDate = new DateTime(2024, 12, 31, 10, 50, 14, 563, DateTimeKind.Local).AddTicks(2978),
                            SecurityStamp = "15397fe1-2db8-4649-85b8-0a1640c278db",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            BlockedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ConcurrencyStamp = "4375431c-fd84-4c51-acfc-fab6f9d5728d",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEB7ZQxjpa05Z+wJLjvknLnHn/VwRnSpwicg+G6XzYw8OD1uoSjBzmLigQvpwK+2yOw==",
                            PhoneNumberConfirmed = false,
                            RegisterDate = new DateTime(2024, 12, 31, 10, 50, 14, 613, DateTimeKind.Local).AddTicks(6550),
                            SecurityStamp = "82d7c5f9-0696-47eb-ac1e-9560cfec0ece",
                            TwoFactorEnabled = false,
                            UpdateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserIsBlocked = false,
            ...
            modelBuilder.Entity("Domain.Entities.City.CityBase", b =>
                {
                    b.HasOne("Domain.Entities.State.StateBase", "StateBase")
                        .WithOne("CityBase")
                        .HasForeignKey("Domain.Entities.City.CityBase", "StateId");
