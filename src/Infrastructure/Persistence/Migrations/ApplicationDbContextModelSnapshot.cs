...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.AccountLevel", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AccountLevelId"));
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.JobSelectionSlider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.UserLikedGallery", b =>
                {
                    ...
                    b.ToTable("UserLikedGallery", "dbo");
                });
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.Wallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.Wallet", b =>
                {
                    b.HasOne("Ravil.Domain.Models.Data.ApplicationUser", "User")
                        .WithOne("Wallet")
                        .HasForeignKey("Ravil.Domain.Models.Data.Wallet", "UserId");
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.WalletTransaction", b =>
                {
                    b.HasOne("Ravil.Domain.Models.Data.Transaction", "Transaction")
                        .WithMany("WalletTransaction")
                        .HasForeignKey("TransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ravil.Domain.Models.Data.Wallet", "Wallet")
                        .WithMany("WalletTransaction")
