...
namespace Persistence.Migrations
{
    ...
    [Migration("20210630060852_AddHasAttrFieldCategory")]
    partial class AddHasAttrFieldCategory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.JobCategoryAttr", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.Address", b =>
                {
                    ...
                    b.HasOne("Ravil.Domain.Models.Data.State", "State")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.Attr", b =>
                {
                    ...
                    b.HasOne("Ravil.Domain.Models.Data.Category", null)
                        .WithMany("Attrs")
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.JobBranch", b =>
                {
                    b.HasOne("Ravil.Domain.Models.Data.Brand", null)
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.JobCategoryAttr", b =>
                {
                    b.HasOne("Ravil.Domain.Models.Data.Attr", "Attr")
                        .WithMany("AttrJobCategories")
                        .HasForeignKey("AttrId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ravil.Domain.Models.Data.JobCategory", "JobCategory")
                        .WithMany("JobCategoryAttributes")
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.Order", b =>
                {
                    ...
                    b.HasOne("Ravil.Domain.Models.Data.PromotionCode", null)
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.UsersFeedbackSlider", b =>
                {
                    ...
                    b.HasOne("Ravil.Domain.Models.Data.Job", null)
                        .WithMany("UsersFeedbackSliders")
                        .HasForeignKey("JobId1");
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.Attr", b =>
                {
                    ...
                    b.Navigation("AttrJobCategories");
            ...
            modelBuilder.Entity("Ravil.Domain.Models.Data.JobCategory", b =>
                {
                    b.Navigation("JobCategoryAttributes");
                });
