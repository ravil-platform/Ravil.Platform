            ...
            modelBuilder.Entity("Domain.Entities.Address.Address", b =>
                {
                    ...
                    b.Property<DateTime>("UpdateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 12, 31, 11, 50, 24, 108, DateTimeKind.Local).AddTicks(8995));
            ...
            modelBuilder.Entity("Domain.Entities.User.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "b294f3a6-1f8e-4793-87f6-3596c9f9c298",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEGfowiDX4y5Pzt3gt7yRrcN6takUnIaN4r/iGOhMiLTdESveQdI2HJoWLPTHhPLQIQ==",
                            PhoneNumberConfirmed = false,
                            RegisterDate = new DateTime(2024, 12, 31, 11, 50, 24, 121, DateTimeKind.Local).AddTicks(7407),
                            SecurityStamp = "9f583ec6-2f3a-4e91-8627-3f55b812bbb4",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            BlockedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ConcurrencyStamp = "876488be-9438-47aa-8d36-b8bc9f0e3c91",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEOrbx9DlgRoce5le7Mx3OjjDr2Uynxn4NHFcscw9MBxO5TT63ykopYXLvIR7XEOm0Q==",
                            PhoneNumberConfirmed = false,
                            RegisterDate = new DateTime(2024, 12, 31, 11, 50, 24, 169, DateTimeKind.Local).AddTicks(1946),
                            SecurityStamp = "6cef9361-606b-4db4-a5db-6c47b3bf5ab3",
                            TwoFactorEnabled = false,
                            UpdateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserIsBlocked = false,
