...
public class JobConfigurations : IEntityTypeConfiguration<Domain.Entities.Job.Job>
{
    public void Configure(EntityTypeBuilder<Domain.Entities.Job.Job> builder)
    {
        ...
        builder.Property(j => j.SubTitle).IsRequired().HasMaxLength(MaxLength.Title);
        builder.Property(j => j.Summary).IsRequired().HasMaxLength(MaxLength.Summary);
        builder.Property(j => j.Content).IsRequired().HasMaxLength(MaxLength.Content);
        builder.Property(j => j.LargePicture).IsRequired().HasMaxLength(MaxLength.Picture);
        builder.Property(j => j.SmallPicture).IsRequired().HasMaxLength(MaxLength.Picture);
        ...
        builder.Property(j => j.PhoneNumberInfos).IsRequired(false).HasMaxLength(MaxLength.Phone);
