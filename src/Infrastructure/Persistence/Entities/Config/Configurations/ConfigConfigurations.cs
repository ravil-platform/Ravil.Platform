namespace Persistence.Entities.Config.Configurations
{
    public class ConfigConfigurations : IEntityTypeConfiguration<Domain.Entities.Config.Config>
    {
        public void Configure(EntityTypeBuilder<Domain.Entities.Config.Config> builder)
        {
            ...
            builder.Property(c => c.OrderNumber).IsRequired(false);
            builder.Property(c => c.FreeShippingLimit).IsRequired(false);
            builder.Property(c => c.ShippingPrice).IsRequired(false);
            builder.Property(c => c.ShippingTimeRange).IsRequired(false);
            builder.Property(c => c.ZarinpalUrl).IsRequired(false);
            builder.Property(c => c.ZarinpalMode).IsRequired(false);
            builder.Property(c => c.ZarinpalMerchant).IsRequired(false);
            builder.Property(c => c.IsMultipleCreate).IsRequired(false);
            builder.Property(c => c.SendNotificationState).IsRequired(false);
            ...
            builder.Property(c => c.MobileSupportButtonIsShow).IsRequired(false);
            builder.Property(c => c.UseSliderOrVideoInHome).IsRequired(false);
            ...
            builder.Property(c => c.ExternalLoginState).IsRequired(false);
            builder.Property(c => c.NoIndexSeoPages).IsRequired(false);
            builder.Property(c => c.RedirectSeoPages).IsRequired(false);
